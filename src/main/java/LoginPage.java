...
private final By messageErrorLocator = By.xpath(".//p[text()='Некорректный пароль']");
    ...
    @Step("Заполнить поля для входа в аккаунт")
